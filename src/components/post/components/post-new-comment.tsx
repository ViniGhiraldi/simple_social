...
export const PostNewComment = ({handleOnChange, handleOnClick, inputValue, username, avatar}: IPostNewComment) => {
    return (
        <>
            ...
            <Input type='text' value={inputValue} className='rounded-full bg-input shadow-inner' placeholder='Comente algo...' onChange={e => handleOnChange(e.currentTarget.value)} />
